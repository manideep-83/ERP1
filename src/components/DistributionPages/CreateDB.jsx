    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.filterBox}>
          ...
          <View style={styles.inputWrap}>
            ...
            <LabeledUnderlineInput label="Name" placeholder="Two Wheeler" />
            <LabeledUnderlineInput label="Phone Number" placeholder="" />
            <LabeledUnderlineInput label="Email ID" placeholder="" />
            <LabeledUnderlineInput label="Daily Allowance" placeholder="" />
