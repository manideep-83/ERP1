...
const mastersData = [
  { "id": "1", "name": "Bank Split Report", "icon": "document-text-outline" },
  { "id": "2", "name": "Customer Outstanding", "icon": "person-outline" },
  { "id": "3", "name": "Collection Report", "icon": "cash-outline" },
  { "id": "4", "name": "Pending Bills Report", "icon": "receipt-outline" },
  { "id": "5", "name": "Retailer Wise Comp", "icon": "stats-chart-outline" }
];
