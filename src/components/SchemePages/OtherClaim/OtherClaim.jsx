...
const OtherClaim = () => {
    ...
    const [claimData, setClaimData] = useState([
        ...
        { id: 3, name: 'Product C', date: '15-09-2023' },
    ]);
    ...
    //     // Navigate to the 'CreateNewOtherClaim' screen
    //     navigation.navigate('CreateNewOtherClaim');
    // };

    const handleView = (item) => {
        // Navigate to the overview screen with the selected item's data
        navigation.navigate('OtherClaimOverview', { claim: item });
    };
        ...
        <SafeAreaView style={styles.safeArea}>
            <ScrollView style={styles.container}>
                <View style={styles.headerRow}>
                    <Text style={styles.title}>Others Claim</Text>
