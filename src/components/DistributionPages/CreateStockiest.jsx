      ...
      <View style={styles.filterBox}>
        <View style={{display:"flex", flexDirection:"row"}}>
          <View style={styles.inputWrap}>
            ...
            <LabeledUnderlineInput label="Sub Stockiest Route" placeholder="" />
            <LabeledUnderlineInput label="Sub Stockiest" placeholder="Two Wheeler" />
            <LabeledUnderlineInput label="From Date" placeholder="" />
            <LabeledUnderlineInput label="To Date" placeholder="" />
            </View>
            <View>
                <Text>Sales Return Invoice No's</Text>
            </View>
        </View>
...
export default CreateStockiest;
