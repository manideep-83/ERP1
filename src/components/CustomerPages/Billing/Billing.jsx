...
const Billing = () => {
  ...
  const handleView = (item) => navigation.navigate('BillingOverview', { item });
  ...
  const columns = [
    ...
    { header: 'Retailer Name', key: 'name', flex: 2 },
    { header: 'Salesman', key: 'date', flex: 2 },
  ...
  return (
    <View>
      ...
      <TouchableOpacity style={styles.Button} onPress={() => navigation.navigate('CreateBilling')}>
