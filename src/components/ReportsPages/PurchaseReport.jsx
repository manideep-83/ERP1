...
const mastersData = [
  { "id": "1", "name": "GRN Listing Report", "icon": "list-outline" },
  { "id": "2", "name": "Product Purchase Report", "icon": "bar-chart-outline" },
  { "id": "3", "name": "Purchase Return Report", "icon": "arrow-back-circle-outline" },
  { "id": "4", "name": "Purchase Discount Report", "icon": "pricetag-outline" },
  { "id": "5", "name": "Product Wise Input", "icon": "create-outline" },
  { "id": "6", "name": "Product Return SA", "icon": "repeat-outline" },
  { "id": "7", "name": "Delivery Challan", "icon": "cube-outline" },
  { "id": "8", "name": "Input Tax Summary", "icon": "calculator-outline" }
];
