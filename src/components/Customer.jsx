...
const customerData = [
  ...
  { id: '4', name: 'Retailer', icon: require('../../Assets/distribution/icon-park-outline_engineering-vehicle-1.png'), route: 'Retailer' },
  { id: '5', name: 'Delivery Process', icon: require('../../Assets/distribution/mdi_human-male.png'), route: 'DeliveryProcess' },
