...
const mastersData = [
  { id: '1', name: 'Batch Transfer', icon: require('../../Assets/inventory/tabler_transfer.png') },
  { id: '2', name: 'Godown', icon: require('../../Assets/inventory/mdi_calculator.png') },
  { id: '3', name: 'Stock Adjust', icon: require('../../Assets/inventory/bi_circle-half.png') },
];
