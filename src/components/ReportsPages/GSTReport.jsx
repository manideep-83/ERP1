...
const mastersData = [
  { "id": "1", "name": "Output Tax Report", "icon": "document-text-outline" },
  { "id": "2", "name": "GSTR 3B", "icon": "receipt-outline" },
  { "id": "3", "name": "GST Product Wise", "icon": "cube-outline" },
  { "id": "4", "name": "GST Sales Summary", "icon": "stats-chart-outline" },
  { "id": "5", "name": "E-Way Bill Report", "icon": "document-outline" }
];
