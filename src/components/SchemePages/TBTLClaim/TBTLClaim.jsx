...
const TBTLClaim = () => {
    ...
    //     navigation.navigate('CreateTBTLClaim'); // Assuming a route for creating a new claim
    // };

    const handleView = (item) => {
        navigation.navigate('TBTLClaimOverview', { claim: item });
    };
        ...
        <SafeAreaView style={styles.safeArea}>
            <ScrollView style={styles.container}>
                <View style={styles.headerRow}>
                    <Text style={styles.title}>TBTL Claim</Text>
                    {/* <AppButton
                        label="+ Create new"
