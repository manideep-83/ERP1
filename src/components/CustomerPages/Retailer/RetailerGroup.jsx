...
const RetailerGroup = () => {
  ...
  const handleView = (item) => navigation.navigate('RetailerGroupOverview', { item });
  ...
  const columns = [
    { header: 'Retailer Channel Name', key: 'id', flex: 1 },
    { header: 'Retailer Group Code', key: 'name', flex: 2 },
    {
      header: 'Action',
      key: 'action',
      flex: 1,
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Retailer Group</Text>

      {/* Create New Button */}
      {/* <AppButton
        label="+ Create New"
        onPress={() => navigation.navigate('CreateRetailerGroup')}
