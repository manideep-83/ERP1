...
const OtherServiceClaims = () => {
    const navigation = useNavigation();

    // --- State for managing live data ---
    const [claimData, setClaimData] = useState([
        { id: 101, name: 'Service A Claim', date: '12-08-2023' },
        { id: 102, name: 'Service B Claim', date: '12-09-2023' },
    ]);
    ...
    //     // Navigate to the 'CreateOtherServiceClaims' screen
    //     navigation.navigate('CreateOtherServiceClaims'); 
    // };

    const handleView = (item) => {
        // Navigate to the overview screen with the selected item's data
        navigation.navigate('OtherServiceClaimsOverview', { claim: item });
    };

    const handleDelete = (itemToDelete) => {
        Alert.alert(
            'Delete Other Service Claim',
        ...
        <SafeAreaView style={styles.safeArea}>
            <ScrollView style={styles.container}>
                <View style={styles.headerRow}>
                    <Text style={styles.title}>Other Service Claims</Text>
                    {/* <AppButton
                        label="+ Create new"
...
export default OtherServiceClaims;