...
const ManualClaim = () => {
    ...
    const handleCreateNew = () => {
        navigation.navigate('CreateNewManualClaim');
    };

    const handleView = (item) => {
        navigation.navigate('ManualClaimOverview');
    };

    const handleDelete = (itemToDelete) => {
        Alert.alert(
            'Confirm Delete',
            `Are you sure you want to delete this Manual Claim?`,
            [
                { text: 'Cancel', style: 'cancel' },
                {
                    ...
                    onPress: () => {
                        ...
                        console.log('Manual Claim deleted', itemToDelete);
                    }
                },
            ]
        );
        ...
        <SafeAreaView style={styles.safeArea}>
            <ScrollView style={styles.container}>
                <View style={styles.headerRow}>
                    <Text style={styles.title}>Manual Claim</Text>
                    <AppButton
                        label="+ Create new"
