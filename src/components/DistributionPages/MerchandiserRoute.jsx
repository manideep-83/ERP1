...
const MerchandiserRoute = () => {
  ...
  { 
    ...
    flex: 1,
    renderCell: (item) => (
      <TouchableOpacity onPress={() =>{change("MerchandiserRouteOverview")}}>
        <Text>Show</Text>
      </TouchableOpacity>
...
const data = [
  ...
  return (
    <View>
        ...
        <Text style={styles.title}>Merchandiser Route</Text>
        <TouchableOpacity style={styles.Button} onPress={() => {change("CreateMerchRoute")}}>
