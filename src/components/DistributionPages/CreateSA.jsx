    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.filterBox}>
          ...
          <View style={styles.inputWrap}>
            ...
            <LabeledUnderlineInput label="Search By" placeholder="" />
            </View>
            <LabeledUnderlineInput label="Search Input" placeholder="Two Wheeler" />
            <LabeledUnderlineInput label="GST State Name" placeholder="" />
            <LabeledUnderlineInput label="Retailer Name" placeholder="" />
            <LabeledUnderlineInput label="Address" placeholder="" />
            <View style={styles.Vrow}>
            <LabeledUnderlineInput label="Country" placeholder="" />
            <LabeledUnderlineInput label="State" placeholder="" />
            </View>
            <View style={styles.Vrow}>
            <LabeledUnderlineInput label="City" placeholder="" />
            <LabeledUnderlineInput label="Postal Code" placeholder="" />
            </View>
...
const styles = StyleSheet.create({
  ...
  Vrow:{display:"flex",flexDirection:"row", justifyContent:"space-between"},
