...
const LeakageDamageReturnClaim = () => {
    ...
    const handleCreateNew = () => {
        navigation.navigate('CreateLeakageDamageReturnClaim');
    };

    const handleView = (item) => {
        navigation.navigate('LeakageDamageReturnClaimOverview');
    };
            ...
            [
                { text: 'Cancel', style: 'cancel' },
                {
                    ...
                    onPress: () => {
                        ...
                        console.log('Leakage/Damage Return Claim deleted', itemToDelete);
                    }
                },
            ]
        );
        ...
        <SafeAreaView style={styles.safeArea}>
            <ScrollView style={styles.container}>
                <View style={styles.headerRow}>
                    <Text style={styles.title}>Leakage Damage Return Claim</Text>
                    <AppButton
                        label="+ Create new"
...
export default LeakageDamageReturnClaim;