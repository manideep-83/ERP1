...
const mastersData = 
 [
  { "id": "1", "name": "Sales Details Report", "icon": "receipt-outline" },
  { "id": "2", "name": "Product Price List Report", "icon": "pricetags-outline" },
  { "id": "3", "name": "Irn Report", "icon": "document-text-outline" },
  { "id": "4", "name": "Contract Pricing", "icon": "document-outline" },
  { "id": "5", "name": "Distributor JC Review", "icon": "people-outline" },
  { "id": "6", "name": "Leakage & Damage", "icon": "alert-circle-outline" }
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.contentContainer}>
        <Text style={styles.title}>Informative Report</Text>
