    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.filterBox}>
          ...
          <View style={styles.inputWrap}>
            ...
            <LabeledUnderlineInput label="To Date" placeholder="Two Wheeler" />
            <LabeledUnderlineInput label="Salesman" placeholder="" />
            <LabeledUnderlineInput label="Delivery Route " placeholder="" />
            <View style={styles.row}>
            <LabeledUnderlineInput label="Sales Route" placeholder="" />
            <TouchableOpacity style={styles.Buttons}>
                   <Text style={styles.buttonText}>Populate</Text>
                 </TouchableOpacity>
            </View>
            <Text>Auto vehicle Allocation</Text>
