...
const CreateCollectionDiscountMaster = () => {
        ...
        { header: 'Collection Mode', key: 'collectionMode', flex: 2 },
        {
            ...
            renderCell: (item) => (
                <View style={styles.actionCell}>
                    <TouchableOpacity onPress={() => console.log(`View discount for ${item.retailer}`)} style={{ marginRight: 10 }}>
                        <Ionicons name="eye-outline" size={20} color="#007bff" />
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => console.log(`Delete discount for ${item.retailer}`)}>
...
export default CreateCollectionDiscountMaster;
